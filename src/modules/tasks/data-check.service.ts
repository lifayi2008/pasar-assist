...
export class DataCheckService {
  ...
  async OrderAndTokenCountCheck() {
    ...
    const [web3OrderCount, web3TokenCount] = await this.web3Service.web3BatchRequest(
      [
        {
          method: this.web3Service.pasarContractRPC[Chain.ELA].methods.getOrderCount().call,
          params: {},
        },
        {
          method: this.web3Service.stickerContractRPC[Chain.ELA].methods.totalSupply().call,
          params: {},
        },
      ],
      Chain.ELA,
